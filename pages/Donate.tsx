    ...
    <div className="py-16 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-serif font-bold text-comfort-blue mb-4">Faire un Don</h1>
          <p className="text-xl text-gray-600">Votre générosité transforme des vies. 100% de votre don soutient nos programmes.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 bg-white p-8 rounded-lg shadow-md border border-gray-100">
            ...
            <div className="mb-8">
              <label className="block text-sm font-medium text-gray-700 mb-2">Autre Montant</label>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <input type="text" placeholder="Prénom" className="border p-3 rounded" />
              <input type="text" placeholder="Nom" className="border p-3 rounded" />
            </div>
            <input type="email" placeholder="Adresse Email" className="border p-3 rounded w-full mb-6" />
            ...
            <button className="w-full bg-comfort-blue text-white text-lg font-bold py-4 rounded hover:bg-blue-900 transition-colors shadow-lg">
              Faire un don de ${amount || customAmount || '0'}
            </button>
            
            <p className="text-xs text-gray-400 mt-4 flex items-center justify-center">
              <Lock size={12} className="mr-1" /> Paiement sécurisé via Stripe/PayPal
            </p>
          </div>
          ...
          <div className="md:col-span-1">
             <div className="bg-blue-900 text-white p-6 rounded-lg shadow-lg mb-6">
               <h3 className="font-bold text-lg mb-2">Pourquoi donner ?</h3>
